...
def generate_info(cache):
    ...
    while True:
        ...
        try:
            ...
            account = random.choice(test_curls)
            spider = WeiboCommentSpider(xhr_url, account, WEIBO_ACCOUNT_PASSWD, timeout=20, delay=3)
            ...
            res = spider.parse_tweet_list(uri, cache)
            if len(res) == 2:
